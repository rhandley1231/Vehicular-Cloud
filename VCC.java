...
public class VCC {
    ...
    private void handleClientRequest(Socket clientSocket) {
        try (
            ...
            // Simulate processing and decide if the request is accepted
            boolean requestIsAccepted = /* Your logic to determine acceptance */ true;

            // Send a response to the client
            if (requestIsAccepted) {
                serverOutputStream.writeUTF("Accepted");
            } else {
                serverOutputStream.writeUTF("Rejected");
            }
            serverOutputStream.flush();
        } catch (IOException e) {
            e.printStackTrace();
        } finally {
            // Close streams and socket if necessary
            try {
                clientSocket.close();
            } catch (IOException e) {
                e.printStackTrace();
    ...
    private void startServer() {
        ...
        while (true) {
            try {
                ...
                // Handle the client request in a separate thread or method
    ...
    public static void main(String[] args) {
        VCC vcc = new VCC();
        vcc.dbConnect(); // Assuming this method initializes the database connection
        vcc.runServer(); // Your existing server startup code
        // Continue with other initialization or user interactions...
    }
